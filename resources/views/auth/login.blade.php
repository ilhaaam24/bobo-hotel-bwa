        ...
        <div class="flex flex-col gap-6">
          <div class="input-container flex flex-col gap-2">
            ...
            <div class="group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
              ...
              <input type="email" name="email" id="email" class="appearance-none outline-none w-full bg-white placeholder:text-[#757C98] placeholder:font-medium text-sm font-semibold" placeholder="example@gmail.com" required>
            </div>
          </div>
          <div class="input-container flex flex-col gap-2">
            ...
            <div class="group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
              ...
              <input type="password" name="password" id="password" class="appearance-none outline-none w-full bg-white placeholder:text-[#757C98] placeholder:font-medium text-sm font-semibold" placeholder="Enter your password" required>
