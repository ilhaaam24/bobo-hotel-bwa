            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action=" {{route('admin.hotel_rooms.update', $hotelRoom)}}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="price" class="block mt-1 w-full" type="number" value="{{$hotelRoom->price}}" name="price" 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="total_people" class="block mt-1 w-full" type="number" value="{{$hotelRoom->total_people}}" name="total_people" 
