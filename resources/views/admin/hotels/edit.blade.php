            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                <form method="POST" action="{{route('admin.hotels.update', $hotel)}} " enctype="multipart/form-data"> 
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" value="{{$hotel->name}}" name="name" 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="link_gmaps" class="block mt-1 w-full" value="{{$hotel->link_gmaps}}" type="text" name="link_gmaps" 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="star_level" class="block mt-1 w-full" value="{{$hotel->star_level}}" type="number" name="star_level"  required autofocus autocomplete="star_level" />
